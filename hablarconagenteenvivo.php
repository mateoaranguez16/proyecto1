...
<head>
  ...
  <link rel="stylesheet" href="../css/hablarconagenteenvivo.css">
...
<body>
      ...
      <div class="search-bar">
        <form action="#" method="get">
          ...
          <button id="button-search" type="submit">
            <img src="../img/iconobuscar.png" alt="Buscar" width="20">
          </button>
        </form>
      </div>
      ...
      <div class="nav-icons">
        ...
        <div id="user-menu" style="display:none; position:absolute; background:#fff; border:1px solid #ccc; padding:10px; box-shadow:0 2px 5px rgba(0,0,0,0.2); z-index:100;">
          <ul style="list-style:none; margin:0; padding:0;">
            ...
            <li><a href="../php/logout.php" style="text-decoration:none; color:#333; display:block; padding:5px 10px;">Cerrar sesión</a></li>
          </ul>
        </div>
  ...
  <div class="container-consulta">
    <h1 class="consulta-title">Enviar Consulta</h1>
    <form id="consulta-form">
      <label for="tipo_consulta">Tipo de consulta</label>
      <select id="tipo_consulta" name="tipo_consulta" required>
        <option value="" disabled selected>Selecciona tipo de consulta</option>
      ...
      <textarea id="descripcion" name="descripcion" rows="5" placeholder="Escribe aquí tu consulta..." required></textarea>

      <div class="consulta-buttons">
        <button type="button" id="btnEnviar">Enviar Consulta</button>
        <button type="button" id="btnChatAgente">Hablar con un agente en vivo</button>
      </div>
    </form>
  </div>
  ...
  <div id="modalOverlay" class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="modalTitle" tabindex="-1">
    <div class="modal-content">
      <h2 id="modalTitle">Selecciona el servicio de correo</h2>
      <button data-service="gmail">Enviar con Gmail</button>
      <button data-service="outlook">Enviar con Outlook</button>
      <button data-service="yahoo">Enviar con Yahoo</button>
      <button id="closeModal" class="close-btn">Cancelar</button>
    </div>
  </div>
  ...
  <script src="../js/hablarconagenteenvivo.js"></script>
