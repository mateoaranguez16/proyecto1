...
<head>
    ...
    <link rel="stylesheet" href="src/pages/css/perfil.css" />
</head>
<body>
    <header>
        <nav>
    ...
    <div class="profile-container">
        ...
        <section class="orders">
            ...
            <ul>
                <li>También puedes consultar el estado de tus pedidos por <a href="">whatsapp</a></li>
            </ul>
    ...
    <script>
        fetch('src/pages/php/getUser.php')
