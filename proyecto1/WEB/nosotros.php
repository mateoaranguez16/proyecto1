...
<head>
  ...
  <link rel="stylesheet" href="src/pages/css/nosotros.css">
    ...
    <nav>
      ...
      <div class="search-bar">
        <form action="#" method="get">
          ...
          <button type="submit"><img src="src/icon/iconobuscar.png" alt="Buscar" width="20"></button>
        </form>
      </div>
      ...
      <div class="nav-icons" style="position: relative;">
        ...
        <div id="user-menu" class="dropdown-menu">
          <ul>
            ...
            <li><a href="src/pages/php/logout.php">Cerrar sesión</a></li>
          </ul>
        </div>

        <!-- Carrito -->
        <div id="cart-icon">
          <img src="src/icon/carritodecompras.png" alt="Carrito" width="28" title="Carrito">
  ...
  <main id="nosotros">
    ...
    <section class="historia nosotros-container">
      ...
      <div class="nosotros-imagen">
        <img src="src/img/historia.png" alt="Historia de Marca Ropa">
      </div>
    </section>
    ...
    <section class="equipo nosotros-container">
      ...
      <div class="equipo-grid">
        <div class="miembro">
          <img src="src/img/persona1.png" alt="Alejandro Sarmiento">
          <h4>Alejandro Sarmiento</h4>
          <p>Diseñador Principal</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona2.png" alt="Uriel Torterola">
          <h4>Uriel Torterola</h4>
          <p>Coordinadora de Producción</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona3.png" alt="Adrian Vega">
          <h4>Adrian Vega</h4>
          <p>Marketing & Estrategia</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona4.png" alt="Pedro Wang">
          <h4>Pedro Wang</h4>
          <p>Atención al Cliente</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona4.png" alt="Mateo Aranguez">
          <h4>Mateo Aranguez</h4>
          <p>Atención al Cliente</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona4.png" alt="Alex Baruc">
          <h4>Alex Baruc</h4>
          <p>Atención al Cliente</p>
        </div>
        <div class="miembro">
          <img src="src/img/persona4.png" alt="Martin Chamorro">
          <h4>Martin Chamorro</h4>
          <p>Atención al Cliente</p>
        </div>
      </div>
    </section>
