<?php
// Puedes iniciar sesión si luego vas a manejar perfil o carrito
// session_start();
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <!-- Estilos principales -->
    <link rel="stylesheet" href="src/pages/css/style.css">
...
<body>
            ...
            <div class="search-bar">
                <form action="#" method="get">
                    ...
                    <button id="button-search" type="submit">
                        <img src="src/icon/iconobuscar.png" alt="Buscar" width="20">
                    </button>
                </form>
            </div>
    ...
    <section id="historia">
        <div class="historia-container">
            ...
            <div class="historia-image">
                <img src="src/icon/iconopagina.png" alt="Historia de la marca">
            </div>
        </div>
    </section>
    ...
    <section id="nosotros">
        ...
        <img src="src/icon/iconopagina.png" alt="Logo de la marca" class="about-logo">
    </section>
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <p>© <?php echo date('Y'); ?> Marca Ropa. Todos los derechos reservados.</p>
        </div>
    </footer>
