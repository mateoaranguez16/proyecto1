...
<body>
 ...
 <script src="../js/scripts.js"></script>
    ...
    <div class="user-menu-containe reveal">
...
<main style="padding: 2rem;">
  ...
  <div class="payment-section reveal">
    ...
    <form id="form-tarjeta" class="payment-form active reveal" novalidate>
    ...
    <form id="form-transferencia" class="payment-form reveal" novalidate>
    ...
    <div id="form-efectivo" class="payment-form reveal">
...
<footer>
    <div class="footer-container reveal">
        ...
        <div class="footer-col reveal">
            ...
            <p class="footer-mail reveal">📧 info@marcaropa.com</p>
        </div>
    </div>
