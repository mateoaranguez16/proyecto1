...
<body>
  ...
  <main>
    <form class="Logbox" onsubmit="login(event)" method="POST" enctype="multipart/form-data">
      <p class="indtitle">Iniciar Sesión</p>
      ...
      <button type="submit" class="indbutton">Iniciar Sesión</button>
      <div class="Askdiv">
        <h5>¿No tenés cuenta?</h5>
        <a class="AskButton" href="register.php">Crea una</a>
      </div>
    </form>
  </main>
